...
const factory = (AppConfig) => {
    ...
    // AppConfig.surveyURL = "";
    AppConfig.registeredOnlyTypes = ['file', 'contacts', 'notifications', 'support','drive', 'teams', 'sheet', 'doc', 'presentation', 'pad', 'kanban', 'code', 'form', 'poll', 'whiteboard', 'slide', 'convert', 'diagram'];
